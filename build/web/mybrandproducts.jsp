<%-- 
    Document   : mybrandproducts
    Created on : Oct 8, 2014, 10:14:42 PM
    Author     : intel
--%>
        ...
        <table border="0" align="center" class="myprojectlayout" cellpadding="0" cellspacing="0">
            ...
            <tr class="mymiddlesection">
                ...
                <td class="mybodysection" style="background-color:#dddddd">
                    <div>
                        <%
                        String brandidurl=request.getParameter("brandid");
                        ...
                        Class.forName("com.mysql.jdbc.Driver").newInstance();
                         ...
                         String brandname=rs0.getString(2);
                         statement0.close();
                         connection0.close();
                        %>
